...
(when (and (andmap struct? (list C1 C2 C3 C4))
  ...
  (check-part 'd .25 (counter-tt (tt+ (tt+ (tt+ C2 7876) 98787) 3243)) is 109906)
  )

(exercițiul 3 : 20 puncte)
(when (andmap struct? (list C1 C2 C3 C4))
  (check-part 'a .125 (min-tt (list (tt+ C3 10))) is '(3 . 10))
  (check-part 'b .125 (min-tt (list (tt+ C1 1) (tt+ C2 32) C4)) is '(4 . 0))
  (check-part 'c .125 (min-tt (list (tt+ C1 1) (tt+ C2 32) (tt+ C3 32))) is '(1 . 1))
  (check-part 'd .125 (min-tt (list (tt+ C1 64) (tt+ C3 32) (tt+ C2 32) (tt+ C4 42))) is '(2 . 32))
  (check-part 'e .125 (min-tt (list (tt+ C4 7) (tt+ C3 7) (tt+ C1 7) (tt+ C2 7))) is '(1 . 7))
  (check-part 'f .125 (min-tt (list C3 C4 C2)) is '(2 . 0))
  (check-part 'g .125 (min-tt (list (tt+ C1 99999999999) (tt+ C2 9999999) (tt+ C3 999999999))) is '(2 . 9999999))
  (check-part 'h .125 (min-tt (list (tt+ C1 99999999999) (tt+ C2 9999999) (tt+ C3 999999999) (tt+ C4 42))) is '(4 . 42))
  )

(exercițiul 4 : 20 puncte)
(when (andmap struct? (list C1 C2 C3 C4))
  (check-part 'a .125 (min-tt-stack (list (tt+ C3 10))) is '(3 . 10))
  (check-part 'b .125 (min-tt-stack (list (tt+ C1 1) (tt+ C2 32) C4)) is '(4 . 0))
  (check-part 'c .125 (min-tt-stack (list (tt+ C1 1) (tt+ C2 32) (tt+ C3 32))) is '(1 . 1))
  (check-part 'd .125 (min-tt-stack (list (tt+ C1 64) (tt+ C3 32) (tt+ C2 32) (tt+ C4 42))) is '(2 . 32))
  (check-part 'e .125 (min-tt-stack (list (tt+ C4 7) (tt+ C3 7) (tt+ C1 7) (tt+ C2 7))) is '(1 . 7))
  (check-part 'f .125 (min-tt-stack (list C3 C4 C2)) is '(2 . 0))
  (check-part 'g .125 (min-tt-stack (list (tt+ C1 99999999999) (tt+ C2 9999999) (tt+ C3 999999999))) is '(2 . 9999999))
  (check-part 'h .125 (min-tt-stack (list (tt+ C1 99999999999) (tt+ C2 9999999) (tt+ C3 999999999) (tt+ C4 42))) is '(4 . 42))
  )

(exercițiul 5 : 10 puncte)
(when (andmap struct? (list C1 C2 C3 C4))
  (check-part 'a .5 (add-to-counter C3 'ana 11) is (make-counter 3 11 '((ana . 11))))
  (check-part 'b .5 (add-to-counter (add-to-counter (add-to-counter (tt+ C2 10) 'ana 11) 'gogu 4) 'leo 12) is
              (make-counter 2 37 '((ana . 11) (gogu . 4) (leo . 12))))
  )

(exercițiul 6 : 50 puncte)
(when (andmap struct? (list C1 C2 C3 C4))
  (check-part 'a .125 (serve '((ana 3)) C1 C2 C3 C4)
              is (list
  ...
  (check-part 'b .125 (serve '((ana 12)) C1 C2 C3 C4)
              is (list
                  C1
  ...
  (check-part 'c .125 (serve '((delay 1 10) (delay 2 5) (delay 2 7) (delay 4 2)) C1 C2 C3 C4)
              is (list
                  (make-counter 1 10 '())
                  (make-counter 2 12 '())
                  C3
  ...
  (check-part 'd .125 (serve '((ana 12) (mia 2) (mara 4) (ion 7) (gigi 5) (dan 3)) C1 C2 C3 C4)
              is (list
  ...
  (check-part 'e .125 (serve '((ana 12) (mia 2) (mara 4) (ion 7) (gigi 5) (delay 1 5) (delay 3 100) (lia 343) (dan 3)) C1 C2 C3 C4)
              is (list
  ...
  (check-part 'f .125 (serve '((ana 1) (mia 2) (mara 4) (ion 2332) (gigi 3232) (delay 1 5) (delay 3 10) (lia 32) (dan 33232)) C1 C2 C3 C4)
              is (list
  ...
  (check-part 'g .125 (serve '((ana 12) (mia 2) (mara 4) (ion 7) (gigi 5) (delay 1 5) (delay 3 10) (lia 3) (dan 3)) C1 C2 C3 C4)
              is (list
  ...
  (check-part 'h .125 (serve '((ana 12) (mia 2) (mara 4) (delay 1 2) (ion 7) (gigi 5) (delay 1 5) (delay 3 10) (lia 5) (dan 3)) C1 C2 C3 C4)
              is (list
